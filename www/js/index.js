...
function addGroup()
{
    ...
    $("<div id='topgroup-"+(group_size+1)+"-container' class='group-container'><div data-role='collapsible' data-content-theme='c' data-theme='a' id ='group-"+(group_size+1)+"' class='group-"+(group_size+1)+" visible' data-routing='group.html' style = 'width: 70%; float: left'><h3>Group "+(group_size+1)+"</h3></div><a href='#' data-transition='pop' data-role='button' data-inline='true' style='float: left; width: 29%;' data-icon='gear' data-theme='b' data-rel='popup' onclick='$(&quot;#extra-popup-"+(group_size+1)+"&quot;).popup(&quot;open&quot;)'>Extras</a><div data-role='popup' class='extra-popup' id='extra-popup-"+(group_size+1)+"' data-routing='extras.html'></div></div>").appendTo('.groups');
